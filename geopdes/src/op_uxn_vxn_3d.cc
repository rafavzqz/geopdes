/* Copyright (C) 2010, 2011, 2020 Carlo de Falco, Rafael Vazquez
...
")
{
  ...
  for (iel=0; iel < nel; iel++) 
    if (msh.area (iel) > 0.0)
      ...
      {warning_with_id ("geopdes:zero_measure_element", "op_uxn_vxn_3d: element %lld has 0 area", static_cast<long long int> (iel));}
