% OP_GRADSYMV_N_F: assemble the right hand-side vector r = [r(i)], r(i) = (epsilon (gradsym v n)_i, f).
%
%   rhs = op_gradsymv_n_f (spv, msh, coeff);
%
% INPUT:
%
...
function rhs = op_gradsymv_n_f (spv, msh, coeff)
