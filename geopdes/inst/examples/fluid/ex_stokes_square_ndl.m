% EX_STOKES_SQUARE_NDL: solve the Stokes problem in the unit square with generalized Nedelec elements of the second family.
...
output_file = 'SQUARE_NDL_Deg3_Reg2_Sub10';
...
%! assert (space_v.ndof, 644)
%! assert (error_l2_p, 1.96345892858352e-08, 1e-15)
%! assert (error_h1_v, 9.54443704246158e-08, 1e-15)
%! assert (error_l2_v, 1.54091389875648e-09, 1e-15)