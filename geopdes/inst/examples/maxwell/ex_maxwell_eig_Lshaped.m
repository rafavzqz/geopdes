% EX_MAXWELL_EIG_LSHAPED: solve Maxwell eigenproblem in the L-shaped domain.
...
%! assert (nzeros, 171)
%! assert (eigv(nzeros+(1:5)), [1.47283540635722; 3.53399368976646; 9.86962050365007; 9.86962103171719; 11.38943951321592], 1e-13)