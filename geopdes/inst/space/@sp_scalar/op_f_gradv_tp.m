% OP_F_GRADV_TP: assemble the right-hand side vector r = [r(i)], with  r(i) = (f, grad v_i), exploiting the tensor product structure.
%
%   rhs = op_f_gradv_tp (spv, msh, coeff);
%
% INPUT:
%     
...
function rhs = op_f_gradv_tp (space, msh, coeff)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    rhs = rhs + op_f_gradv (sp_col, msh_col, coeff (x{:}));
  end
