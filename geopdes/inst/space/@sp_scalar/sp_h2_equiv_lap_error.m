...
function [errh2, errh1, errl2, errh2s, errh1s] = sp_h2_equiv_lap_error (sp, msh, u, uex, graduex, lapuex)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    sp_col  = sp_evaluate_col (sp, msh_col, 'gradient', true, 'laplacian', true);

    [~, ~, err_l2, err_h2s, err_h1s] = sp_h2_equiv_lap_error (sp_col, msh_col, u, uex, graduex, lapuex);
