...
function varargout = op_KL_shells_tp (space_u, space_v, msh, E_coeff, nu_coeff, t_coeff)
  ...
  A = spalloc (msh.rdim*space_v.ndof, msh.rdim*space_u.ndof, 3*msh.rdim*space_u.ndof);
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    sp_col_u = sp_scalar2vector_param (sp_col_u, msh_col, 'value', true, 'gradient', true, 'hessian', true);
    sp_col_v = sp_scalar2vector_param (sp_col_v, msh_col, 'value', true, 'gradient', true, 'hessian', true);
