% OP_DIVU_DIVV_TP: assemble the matrix A = [a(i,j)], a(i,j) = (epsilon div u_j, div v_i), exploiting the tensor product structure.
%
%   mat = op_divu_divv_tp (spu, spv, msh, [epsilon]);
%   [rows, cols, values] = op_divu_divv_tp (spu, spv, msh, [epsilon]);
%
% INPUT:
%
...
% 
% Copyright (C) 2011, 2015, 2016, 2017 Rafael Vazquez
%
...
function varargout = op_divu_divv_tp (space1, space2, msh, coeff)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + op_divu_divv (sp1_col, sp2_col, msh_col, coeffs);
  end
