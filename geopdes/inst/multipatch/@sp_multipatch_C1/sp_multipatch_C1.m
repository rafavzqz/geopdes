      ...
      for j2 = 0:2-j1
        ...
        if (reg < pp-2)
          M_prev(:,jfun) = sigma^(j1+j2)*[c0, ...
                                          c0+c1_a/(pp*(kk+1)), ...
                                          c0+2*c1_a/(pp*(kk+1))+c2_a/(pp*(pp-1)*(kk+1)^2), ...
                                          d0_a/(pp*(kk+1)), ...
                                          d0_a/(pp*(kk+1))+d1_a/(pp*(pp-1)*(kk+1)^2)].';
          M_next(:,jfun) = sigma^(j1+j2)*[c0, ...
                                          c0+c1_b/(pp*(kk+1)), ...
                                          c0+2*c1_b/(pp*(kk+1))+c2_b/(pp*(pp-1)*(kk+1)^2), ...
                                          d0_b/(pp*(kk+1)), ...
                                          d0_b/(pp*(kk+1))+d1_b/(pp*(pp-1)*(kk+1)^2)].';
        else
          M_prev(:,jfun) = sigma^(j1+j2)*[c0, ...
                                          c0+c1_a/(pp*(kk+1)), ...
                                          c0+3*c1_a/(pp*(kk+1))+2*c2_a/(pp*(pp-1)*(kk+1)^2), ...
                                          d0_a/(pp*(kk+1)), ...
                                          d0_a/(pp*(kk+1))+d1_a/(pp*(pp-1)*(kk+1)^2)].';
          M_next(:,jfun) = sigma^(j1+j2)*[c0, ...
                                          c0+c1_b/(pp*(kk+1)), ...
                                          c0+3*c1_b/(pp*(kk+1))+2*c2_b/(pp*(pp-1)*(kk+1)^2), ...
                                          d0_b/(pp*(kk+1)), ...
                                          d0_b/(pp*(kk+1))+d1_b/(pp*(pp-1)*(kk+1)^2)].';
        end
        %V_{i_m,i}  
