...
function [errh2, errh1, errl2, errh2s, errh1s] = sp_h2_equiv_lap_error (space, msh, u, uex, graduex, lapuex)
...
%     end
    [error_h2(iptc), error_h1(iptc), error_l2(iptc), error_h2s_lap(iptc), error_h1s(iptc)] = ...
        sp_h2_equiv_lap_error (space.sp_patch{iptc}, msh.msh_patch{iptc}, u_ptc, uex, graduex, lapuex);
  ...
  errh2s = sqrt (sum (error_h2s_lap .* error_h2s_lap));
