...
mp_sp_to_vtk_2d (vel, space_v, geometry, gnum, vtk_pts, sprintf ('%s_vel', output_file), 'velocity')
mp_sp_to_vtk_2d (press, space_p, geometry, gnump, vtk_pts, sprintf ('%s_press', output_file), 'pressure')
