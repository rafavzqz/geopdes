% SP_DRCHLT_L2_PROJ_UXN_2D: assign the degrees of freedom of Dirichlet boundaries through an L2 projection.
%                           The imposed condition reads   uxn = h
%
%   [u, dofs] = sp_drchlt_l2_proj_uxn_2d (sp, msh, h, sides)
%
% INPUT:
%
...
function [u, dofs] = sp_drchlt_l2_proj_uxn_2d (sp, msh, h, sides)
