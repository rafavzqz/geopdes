% SP_TO_VTK_2D: Export to VTK format for plotting.
%
%  sp_to_vtk_2d (u, space, geometry, npts, filename, fieldname)
%  sp_to_vtk_2d (u, space, geometry, {upts, vpts}, filename, fieldname)
%
% INPUT:
%     
...
function sp_to_vtk_2d (u, space, geometry, npts, filename, fieldname)
  ...
  msh_to_vtk_2d (F, p, filename, fieldname);
