% GEO_1D_NURBS: construct a geometry map from a structure of the NURBS toolbox.
%
%   output = geo_1d_nurbs (nurbs, pts, ders)
%
% INPUTS:
%     
...
function varargout = geo_1d_nurbs (nurbs, pts, ders)
  ...
  switch (ders)
    ...
    case 1
      ...
      varargout{1} = jac(1,:);
    otherwise
      error ('geo_1d_nurbs: number of derivatives limited to one')
  end
