% EX_LAPLACE_ISO_RING_MIXED_BC: solve the Poisson problem in one quarter of a ring, discretized with NURBS (isoparametric approach).
...
output_file = 'Ring_mixed_bc_NRB_Deg3_Reg2_Sub9';
...
%! assert (error_h1, 0.0248402989872333, 1e-14)
%! assert (error_l2, 0.00150468419538557, 1e-15)