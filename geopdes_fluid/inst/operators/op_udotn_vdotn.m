...
% INPUT:
%   
%  spu:   structure representing the space of trial functions (see sp_vector_div_transform/sp_eval_boundary_side)
%  spv:   structure representing the space of test functions  (see sp_vector_div_transform/sp_eval_boundary_side)
