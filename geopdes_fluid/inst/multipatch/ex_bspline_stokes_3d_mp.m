% EX_BSPLINE_STOKES_3D_MP: Solve a Stokes flow problem on a three-dimensional multipatch domain.
%
...
% Construct msh structure
  ...
  msh{iptc} = msh_3d_tensor_product (breaks, qn, qw); 
  msh{iptc} = msh_push_forward_3d (msh{iptc}, geometry(iptc));

% Construct space structure
  [spv{iptc}, spp{iptc}] = sp_bspline_th_3d_phys (knotsp, degree, msh{iptc});
