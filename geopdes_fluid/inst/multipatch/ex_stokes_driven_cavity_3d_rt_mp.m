% EX_STOKES_DRIVEN_CAVITY_3D_RT_MP: data file for Stokes problem in the 3D driven cavity defined with a multipatch geometry.
...
output_file  = 'DrivenCavity_3D_RT_MP_Deg2_Reg1_Sub2';
