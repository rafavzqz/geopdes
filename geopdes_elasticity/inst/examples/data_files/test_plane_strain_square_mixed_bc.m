% TEST_PLANE_STRAIN_SQUARE_MIXED_BC: data file for plane-strain problem on a square with mixed boundary conditions.
...
output_file = 'plane_strain_square_mixed_bc';
