% EX_BSPLINE_LAPLACE_2D_MP: solve the Laplacian problem in a multipatch geometry.
%
...
mp_sp_to_vtk_2d (u, sp, geometry, gnum, vtk_pts, output_file, 'u')

%!demo
%! test_Lshaped_mp
%! ex_bspline_laplace_2d_mp
