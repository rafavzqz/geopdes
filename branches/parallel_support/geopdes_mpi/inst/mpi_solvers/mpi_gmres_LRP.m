% mpi_gmres_LRP: solve Ax=b with a split preconditioned parallel gmres
%                
%
% [sol, err] = mpi_gmres_LRP (A, b, x0, LP, RP, max_iter, comm)
%
% INPUT:
% 
% A:  matrix
...
% RP: right preconditioning matrix
...
function [sol, err] = mpi_gmres_LRP (A, b, x0, LP, RP, max_iter, comm)
...
%! [L,U] = lu(A);
%! [sol err]=mpi_gmres_LRP(Am,b,x0, L, U, dim, comm);
%! sol_serial=A\b;
%! if(cpu_ID==0)
