% mpi_gmres_RP: solve Ax=b with a right preconditioned parallel gmres
%                
%
% [sol, err] = mpi_gmres_RP (A, b, x0, LP, max_iter, comm)
%
% INPUT:
% 
% A:  matrix
...
function [sol, err] = mpi_gmres_RP (A, b, x0, RP, max_iter, comm)
...
%! [L,U] = lu(A);
%! [sol err]=mpi_gmres_RP(Am,b ,x0,U,dim,comm);
%! sol_serial=A\b;
%! if(cpu_ID==0)
