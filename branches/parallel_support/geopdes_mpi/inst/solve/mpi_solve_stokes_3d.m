...
function [geometry, msh, space_v, vel, space_p, press] = ...
                          mpi_solve_stokes_3d (mpi_comm, problem_data, method_data)
...
[zeta boundary_list] = msh_partition (mpi_size, 'knots', knotsv1, 'degree', degreev1, 'index', mpi_rank+1);
...
[vel_drchlt, drchlt_dofs] = mpi_sp_drchlt_l2_proj (mpi_comm , drchlt_prec, drchlt_solv, space_v, msh, h, drchlt_sides);
