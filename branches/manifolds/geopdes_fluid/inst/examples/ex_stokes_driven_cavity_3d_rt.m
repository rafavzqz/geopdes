% EX_STOKES_DRIVEN_CAVITY_3D_TH: solve the Stokes problem in the driven cavity with generalized Taylor-Hood elements.
...
output_file = 'Driven_cavity_3d_RT_Deg2_Reg1_Sub5';
...
%! assert (space_v.ndof, 1176)
%! div = sp_eval (vel, space_v, geometry, [10 10 10], 'divergence');
