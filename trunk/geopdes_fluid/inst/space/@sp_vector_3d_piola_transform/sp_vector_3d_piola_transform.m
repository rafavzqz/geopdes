% SP_VECTOR_3D_PIOLA_TRANSFORM: Constructor of the class of three-dimensional vectorial spaces, mapped to the physical domain with the Piola transform.
%
%     sp = sp_vector_3d_piola_transform (sp1, sp2, sp3, msh)
%
% INPUTS:
%
%    sp1: space object of the first component of the space (see sp_bspline_3d)
%    sp2: space object of the second component of the space (see sp_bspline_3d)
%    sp3: space object of the third component of the space (see sp_bspline_3d)
...
%        comp_dofs       (1 x 3 cell array)          indices of the degrees of freedom for each component in the parametric domain
...
function sp = sp_vector_3d_piola_transform (sp1, sp2, sp3, msh)
  ...
  if (~isempty (msh.boundary))
    for iside = 1:numel(msh.boundary)
      ...
      boundary.dofs         = [sp_bnd1.dofs, sp_bnd2.dofs+sp1.ndof, sp_bnd3.dofs+sp2.ndof+sp1.ndof];
  ...
  sp.constructor = @(MSH) sp_vector_3d_piola_transform ... 
                           (sp1.constructor (MSH), sp2.constructor (MSH), sp3.constructor (MSH), MSH);
  sp = class (sp, 'sp_vector_3d_piola_transform');
