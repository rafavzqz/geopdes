% MP_INTERFACE_VECTOR_3D: create a global numbering of basis functions in two-dimensional multipatch geometries.
%
...
%  sp:         object representing the space of discrete functions (see sp_vector_3d)
%
% OUTPUT:
%
